angular.module('motoristaAlterarSenhaController', [])
.controller('motoristaAlterarSenhaController', function ($scope, $http, $state, $rootScope, $ionicPopup) {

  $scope.cancelarAlteracaoDeSenha = function () {
